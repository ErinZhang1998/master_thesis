...
In a similar way, language descriptors can be composed to form new concepts applied to different objects. For example, a \textit{large round} cat face versus a \textit{narrow oval} cat face. 
