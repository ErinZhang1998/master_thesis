...
% in each (image, text) pair, the \textit{image} is a sketch, and the \textit{text} is a description of one of the semantic parts in the sketch. Two examples are shown in Figure \ref{modeling.task.sketches}: 
